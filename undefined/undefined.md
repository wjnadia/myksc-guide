...
#### 1.사용자 웹 브라우저를 실행하여 [**https://portal.my.ksc.re.kr**](https://portal.my.ksc.re.kr) 에 접속한 후,  슈퍼컴퓨터 사용자 아이디 및 비밀번호, OTP를 입력하고 접속할 시스템 (누리온/뉴론)을 선택 후  로그인 합니다.                                                  &#x20;
...
#### 2. 시스템(누리온/뉴론) 점검 중에는 해당 시스템에 로그인이 제한됩니다.

<figure><img src="../.gitbook/assets/그림34.png" alt=""><figcaption></figcaption></figure>

#### 3.  KAFE 사용자의 경우 KAFE 회원기관 로그인 버튼을 클릭하고, 아래와 같이 인증 절차를 수행합니다.
